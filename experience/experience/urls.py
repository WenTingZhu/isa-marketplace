...
urlpatterns = [
    ...
    url(r'^verify_authenticator/$',
        'connector.views.verify_authenticator', name='verify_authenticator'),
    url(r'^unauthenticate_user/$',
        'connector.views.unauthenticate_user', name='unauthenticate_user'),
